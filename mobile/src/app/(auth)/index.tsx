import { View, Text, Dimensions, Pressable, ActivityIndicator ,StyleSheet} from "react-native";
import { SafeAreaView } from "react-native-safe-area-context";
import { Image } from "expo-image";
import { Ionicons } from "@expo/vector-icons";
import { AuthView } from '@clerk/expo/native'
import { BlurView } from "expo-blur";
import useSocialAuth from "@/core/hooks/useSocaialAuth";
import { AnimatedOrb } from "@/features/auth/components/AnimatedOrbs";
import { LinearGradient } from "expo-linear-gradient";

const { width, height } = Dimensions.get("window");

const AuthScreen = () => {
  const { handleAppleAuth, handleGoogleAuth, loadingStrategy } = useSocialAuth();
